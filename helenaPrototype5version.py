...
class ApplicationWindow(tk.Frame):
    ...
    def createwidgets(self):
        ...
        # NOCH MACHEN: plot_entry_var, analysis_entry_var
        """ Types of Variable:
        ...
        """ Creation of the buttonframe. In it, the"""
        ...
        self.empty = tk.Label(self.buttonframe, text="\n").grid(row=1, column=5)  # 0+1 row

        """Summary-Window: Here, the chosen x,y-axis and the graph-style and anylsis are shown."""
        self.lbl_summary = tk.Label(self.buttonframe, text="Summary", fg="green", font=("default", 16)).grid(row=2, column=0)
        ...
        self.plot_summary_inp = tk.Label(self.buttonframe, state='disabled', text="")
        ...
        self.analysis_summary_inp = tk.Label(self.buttonframe, state='disabled', text="")
        self.analysis_summary_inp.grid(row=2, column=8)

        self.empty = tk.Label(self.buttonframe, text="").grid(row=3, column=5)  # 0+1 row


        """ Creation of the Tabs. First step: Creation of the tabsframe INTO the buttonframe. You need"""
        ...
        self.empty = tk.Label(self.tab1).grid(row=0, column=9)  # 0+1 row

        self.infox = ttk.Label(self.tab1, text="Here, you can choose which values you want to choose for your x-axis")
        self.infox.grid(row=2, column=0, columnspan=3)

        self.empty = tk.Label(self.tab1).grid(row=3, column=9)

        # # Creation of the option-menu for x. At the beginning empty, afterswards it is filled with the help
        # # of the function options_xy_changed
        self.options_x_axis = [""]
        ...
        self.lbl_x.grid(row=4, column=0, sticky=tk.N + tk.S + tk.E + tk.W)
        ...
        self.inp_x_axis.grid(row=4, column=1, sticky=tk.N + tk.S + tk.E + tk.W)

        self.empty = tk.Label(self.tab1).grid(row=5, column=9)

        # # the x_entry_var is defined as a StringVar. You can use this kind of variable for the later usage of the
        ...
        self.lbl_datapath.grid(row=6, column=0, sticky=tk.N + tk.S + tk.E + tk.W)
        self.x_entry_field = tk.Entry(self.tab1, textvariable=self.x_entry_var)   # eventually: text='empty'
        self.x_entry_field.grid(row=6, column=1)

        self.empty = tk.Label(self.tab1).grid(row=7, column=9)
        ...
        self.result_x.grid(row=8, column=3, rowspan=2, columnspan=2)

        self.empty = tk.Label(self.tab1).grid(row=10, column=9)

        self.lbl_result_path_x = tk.Label(self.tab1, text="Path:").grid(row=11, column=1)
        self.lbl_result_path_x_entry = tk.Label(self.tab1, text="")
        self.lbl_result_path_x_entry.grid(row=11, column=3)
        self.lbl_result_number_x = tk.Label(self.tab1, text="Number of entries:").grid(row=12, column=1)
        self.lbl_result_number_x_entry = tk.Label(self.tab1, text="")
        self.lbl_result_number_x_entry.grid(row=12, column=3)

        """ TAB2: Settings y-axis """
        # # Same procedure as for the x-axis, see above.
        self.empty = tk.Label(self.tab2).grid(row=0, column=0)  # 0+1 row

        self.infoy = ttk.Label(self.tab2, text="Here, you can choose which values you want to choose for your x-axis")
        self.infoy.grid(row=1, column=0, columnspan=9)

        self.empty = tk.Label(self.tab2, text="").grid(row=2, column=0)
        ...
        self.empty = tk.Label(self.tab2, text="").grid(row=4, column=0)
        ...
        self.empty = tk.Label(self.tab2, text="").grid(row=6, column=0)
        ...
        self.result_y.grid(row=7, column=3, rowspan=3, columnspan=2)

        self.empty = tk.Label(self.tab2).grid(row=8, column=9)

        self.lbl_result_path_y = tk.Label(self.tab2, text="Path:").grid(row=11, column=1)
        self.lbl_result_path_y_entry = tk.Label(self.tab2, text="")
        self.lbl_result_path_y_entry.grid(row=11, column=3)
        self.lbl_result_number_y = tk.Label(self.tab2, text="Number of entries:").grid(row=12, column=1)
        self.lbl_result_number_y_entry = tk.Label(self.tab2, text="")
        self.lbl_result_number_y_entry.grid(row=12, column=3)

        """ TAB3: Plot-Options """
        self.empty = tk.Label(self.tab3, text="").grid(row=0, column=0)  # 0+1 row

        self.options_plotting = ["Scatter", "Line", "Sinus", "3D"]
        self.variable_plot = StringVar(self.tab3)     # same for the plotting options
        ...
        self.empty = tk.Label(self.tab3).grid(row=2, column=0)  # 0+1 row
        ...
        self.lbl_analysis.grid(row=3, column=0, sticky=tk.N + tk.S + tk.E + tk.W)
        # same fot zhe OptionMenu with the plotting-methods
        self.inp_analysis = OptionMenu(self.tab3, self.variable_analysis, *self.options_analysis)
        self.inp_analysis.grid(row=3, column=1, sticky=tk.N + tk.S + tk.E + tk.W)

        self.empty = tk.Label(self.tab3).grid(row=4, column=0)  # 0+1 row

        self.plot_f = tk.Button(self.tab3, text="Plot", activeforeground="red")  # NOCH COMMAND SCHREIBEN
        self.plot_f.grid(row=5, column=0, rowspan=2, sticky=tk.N + tk.S + tk.E + tk.W)
    ...
    def selectfile(self):
        ...
        self.tf.tab(self.tab1, state='normal')
    ...
    def option_xy_changed(self):
        ...
        # # add_command:
        # # label="string": the entrys in options_x_axis are inserted into the menux/y.
